...
class Product(models.Model):
    ...
    Availability = models.CharField(max_length=200, choices=Availability, null=True)
...
class UserCreateForm(UserCreationForm):
    email = forms.EmailField(required=True, label="Email", error_messages={'exist': 'This Alerady Exists'})
